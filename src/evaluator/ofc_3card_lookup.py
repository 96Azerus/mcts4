# src/evaluator/ofc_3card_lookup.py v1.2
# -*- coding: utf-8 -*-
...
# ИСПРАВЛЕНО v1.2: Формат rank_string для пар (пара идет первой).

three_card_lookup = {
    (0, 0, 0): (13, 'Trips', '222'),
    (1, 0, 0): (169, 'Pair', '223'), # ИСПРАВЛЕНО
    (1, 1, 0): (157, 'Pair', '332'), # ИСПРАВЛЕНО
    (1, 1, 1): (12, 'Trips', '333'),
    (2, 0, 0): (168, 'Pair', '224'), # ИСПРАВЛЕНО
    (2, 1, 0): (455, 'High Card', '432'),
    (2, 1, 1): (156, 'Pair', '334'), # ИСПРАВЛЕНО
    (2, 2, 0): (145, 'Pair', '442'), # ИСПРАВЛЕНО
    (2, 2, 1): (144, 'Pair', '443'), # ИСПРАВЛЕНО
    (2, 2, 2): (11, 'Trips', '444'),
    (3, 0, 0): (167, 'Pair', '225'), # ИСПРАВЛЕНО
    (3, 1, 0): (454, 'High Card', '532'),
    (3, 1, 1): (155, 'Pair', '335'), # ИСПРАВЛЕНО
    (3, 2, 0): (453, 'High Card', '542'),
    (3, 2, 1): (452, 'High Card', '543'),
    (3, 2, 2): (143, 'Pair', '445'), # ИСПРАВЛЕНО
    (3, 3, 0): (133, 'Pair', '552'), # ИСПРАВЛЕНО
    (3, 3, 1): (132, 'Pair', '553'), # ИСПРАВЛЕНО
    (3, 3, 2): (131, 'Pair', '554'), # ИСПРАВЛЕНО
    (3, 3, 3): (10, 'Trips', '555'),
    (4, 0, 0): (166, 'Pair', '226'), # ИСПРАВЛЕНО
    (4, 1, 0): (451, 'High Card', '632'),
    (4, 1, 1): (154, 'Pair', '336'), # ИСПРАВЛЕНО
    (4, 2, 0): (450, 'High Card', '642'),
    (4, 2, 1): (449, 'High Card', '643'),
    (4, 2, 2): (142, 'Pair', '446'), # ИСПРАВЛЕНО
    (4, 3, 0): (448, 'High Card', '652'),
    (4, 3, 1): (447, 'High Card', '653'),
    (4, 3, 2): (446, 'High Card', '654'),
    (4, 3, 3): (130, 'Pair', '556'), # ИСПРАВЛЕНО
    (4, 4, 0): (121, 'Pair', '662'), # ИСПРАВЛЕНО
    (4, 4, 1): (120, 'Pair', '663'), # ИСПРАВЛЕНО
    (4, 4, 2): (119, 'Pair', '664'), # ИСПРАВЛЕНО
    (4, 4, 3): (118, 'Pair', '665'), # ИСПРАВЛЕНО
    (4, 4, 4): (9, 'Trips', '666'),
    (5, 0, 0): (165, 'Pair', '227'), # ИСПРАВЛЕНО
    (5, 1, 0): (445, 'High Card', '732'),
    (5, 1, 1): (153, 'Pair', '337'), # ИСПРАВЛЕНО
    (5, 2, 0): (444, 'High Card', '742'),
    (5, 2, 1): (443, 'High Card', '743'),
    (5, 2, 2): (141, 'Pair', '447'), # ИСПРАВЛЕНО
    (5, 3, 0): (442, 'High Card', '752'),
    (5, 3, 1): (441, 'High Card', '753'),
    (5, 3, 2): (440, 'High Card', '754'),
    (5, 3, 3): (129, 'Pair', '557'), # ИСПРАВЛЕНО
    (5, 4, 0): (439, 'High Card', '762'),
    (5, 4, 1): (438, 'High Card', '763'),
    (5, 4, 2): (437, 'High Card', '764'),
    (5, 4, 3): (436, 'High Card', '765'),
    (5, 4, 4): (117, 'Pair', '667'), # ИСПРАВЛЕНО
    (5, 5, 0): (109, 'Pair', '772'), # ИСПРАВЛЕНО
    (5, 5, 1): (108, 'Pair', '773'), # ИСПРАВЛЕНО
    (5, 5, 2): (107, 'Pair', '774'), # ИСПРАВЛЕНО
    (5, 5, 3): (106, 'Pair', '775'), # ИСПРАВЛЕНО
    (5, 5, 4): (105, 'Pair', '776'), # ИСПРАВЛЕНО
    (5, 5, 5): (8, 'Trips', '777'),
    (6, 0, 0): (164, 'Pair', '228'), # ИСПРАВЛЕНО
    (6, 1, 0): (435, 'High Card', '832'),
    (6, 1, 1): (152, 'Pair', '338'), # ИСПРАВЛЕНО
    (6, 2, 0): (434, 'High Card', '842'),
    (6, 2, 1): (433, 'High Card', '843'),
    (6, 2, 2): (140, 'Pair', '448'), # ИСПРАВЛЕНО
    (6, 3, 0): (432, 'High Card', '852'),
    (6, 3, 1): (431, 'High Card', '853'),
    (6, 3, 2): (430, 'High Card', '854'),
    (6, 3, 3): (128, 'Pair', '558'), # ИСПРАВЛЕНО
    (6, 4, 0): (429, 'High Card', '862'),
    (6, 4, 1): (428, 'High Card', '863'),
    (6, 4, 2): (427, 'High Card', '864'),
    (6, 4, 3): (426, 'High Card', '865'),
    (6, 4, 4): (116, 'Pair', '668'), # ИСПРАВЛЕНО
    (6, 5, 0): (425, 'High Card', '872'),
    (6, 5, 1): (424, 'High Card', '873'),
    (6, 5, 2): (423, 'High Card', '874'),
    (6, 5, 3): (422, 'High Card', '875'),
    (6, 5, 4): (421, 'High Card', '876'),
    (6, 5, 5): (104, 'Pair', '778'), # ИСПРАВЛЕНО
    (6, 6, 0): (97, 'Pair', '882'), # ИСПРАВЛЕНО
    (6, 6, 1): (96, 'Pair', '883'), # ИСПРАВЛЕНО
    (6, 6, 2): (95, 'Pair', '884'), # ИСПРАВЛЕНО
    (6, 6, 3): (94, 'Pair', '885'), # ИСПРАВЛЕНО
    (6, 6, 4): (93, 'Pair', '886'), # ИСПРАВЛЕНО
    (6, 6, 5): (92, 'Pair', '887'), # ИСПРАВЛЕНО
    (6, 6, 6): (7, 'Trips', '888'),
    (7, 0, 0): (163, 'Pair', '229'), # ИСПРАВЛЕНО
    (7, 1, 0): (420, 'High Card', '932'),
    (7, 1, 1): (151, 'Pair', '339'), # ИСПРАВЛЕНО
    (7, 2, 0): (419, 'High Card', '942'),
    (7, 2, 1): (418, 'High Card', '943'),
    (7, 2, 2): (139, 'Pair', '449'), # ИСПРАВЛЕНО
    (7, 3, 0): (417, 'High Card', '952'),
    (7, 3, 1): (416, 'High Card', '953'),
    (7, 3, 2): (415, 'High Card', '954'),
    (7, 3, 3): (127, 'Pair', '559'), # ИСПРАВЛЕНО
    (7, 4, 0): (414, 'High Card', '962'),
    (7, 4, 1): (413, 'High Card', '963'),
    (7, 4, 2): (412, 'High Card', '964'),
    (7, 4, 3): (411, 'High Card', '965'),
    (7, 4, 4): (115, 'Pair', '669'), # ИСПРАВЛЕНО
    (7, 5, 0): (410, 'High Card', '972'),
    (7, 5, 1): (409, 'High Card', '973'),
    (7, 5, 2): (408, 'High Card', '974'),
    (7, 5, 3): (407, 'High Card', '975'),
    (7, 5, 4): (406, 'High Card', '976'),
    (7, 5, 5): (103, 'Pair', '779'), # ИСПРАВЛЕНО
    ...
    (7, 6, 6): (91, 'Pair', '889'), # ИСПРАВЛЕНО
    (7, 7, 0): (85, 'Pair', '992'), # ИСПРАВЛЕНО
    (7, 7, 1): (84, 'Pair', '993'), # ИСПРАВЛЕНО
    (7, 7, 2): (83, 'Pair', '994'), # ИСПРАВЛЕНО
    (7, 7, 3): (82, 'Pair', '995'), # ИСПРАВЛЕНО
    (7, 7, 4): (81, 'Pair', '996'), # ИСПРАВЛЕНО
    (7, 7, 5): (80, 'Pair', '997'), # ИСПРАВЛЕНО
    (7, 7, 6): (79, 'Pair', '998'), # ИСПРАВЛЕНО
    (7, 7, 7): (6, 'Trips', '999'),
    (8, 0, 0): (162, 'Pair', '22T'), # ИСПРАВЛЕНО
    (8, 1, 0): (399, 'High Card', 'T32'),
    (8, 1, 1): (150, 'Pair', '33T'), # ИСПРАВЛЕНО
    (8, 2, 0): (398, 'High Card', 'T42'),
    (8, 2, 1): (397, 'High Card', 'T43'),
    (8, 2, 2): (138, 'Pair', '44T'), # ИСПРАВЛЕНО
    (8, 3, 0): (396, 'High Card', 'T52'),
    (8, 3, 1): (395, 'High Card', 'T53'),
    (8, 3, 2): (394, 'High Card', 'T54'),
    (8, 3, 3): (126, 'Pair', '55T'), # ИСПРАВЛЕНО
    (8, 4, 0): (393, 'High Card', 'T62'),
    (8, 4, 1): (392, 'High Card', 'T63'),
    (8, 4, 2): (391, 'High Card', 'T64'),
    (8, 4, 3): (390, 'High Card', 'T65'),
    (8, 4, 4): (114, 'Pair', '66T'), # ИСПРАВЛЕНО
    (8, 5, 0): (389, 'High Card', 'T72'),
    (8, 5, 1): (388, 'High Card', 'T73'),
    (8, 5, 2): (387, 'High Card', 'T74'),
    (8, 5, 3): (386, 'High Card', 'T75'),
    (8, 5, 4): (385, 'High Card', 'T76'),
    (8, 5, 5): (102, 'Pair', '77T'), # ИСПРАВЛЕНО
    ...
    (8, 7, 7): (78, 'Pair', '99T'), # ИСПРАВЛЕНО
    (8, 8, 0): (73, 'Pair', 'TT2'), # ИСПРАВЛЕНО
    (8, 8, 1): (72, 'Pair', 'TT3'), # ИСПРАВЛЕНО
    (8, 8, 2): (71, 'Pair', 'TT4'), # ИСПРАВЛЕНО
    (8, 8, 3): (70, 'Pair', 'TT5'), # ИСПРАВЛЕНО
    (8, 8, 4): (69, 'Pair', 'TT6'), # ИСПРАВЛЕНО
    (8, 8, 5): (68, 'Pair', 'TT7'), # ИСПРАВЛЕНО
    (8, 8, 6): (67, 'Pair', 'TT8'), # ИСПРАВЛЕНО
    (8, 8, 7): (66, 'Pair', 'TT9'), # ИСПРАВЛЕНО
    (8, 8, 8): (5, 'Trips', 'TTT'),
    (9, 0, 0): (161, 'Pair', '22J'), # ИСПРАВЛЕНО
    (9, 1, 0): (371, 'High Card', 'J32'),
    (9, 1, 1): (149, 'Pair', '33J'), # ИСПРАВЛЕНО
    (9, 2, 0): (370, 'High Card', 'J42'),
    (9, 2, 1): (369, 'High Card', 'J43'),
    (9, 2, 2): (137, 'Pair', '44J'), # ИСПРАВЛЕНО
    (9, 3, 0): (368, 'High Card', 'J52'),
    (9, 3, 1): (367, 'High Card', 'J53'),
    (9, 3, 2): (366, 'High Card', 'J54'),
    (9, 3, 3): (125, 'Pair', '55J'), # ИСПРАВЛЕНО
    (9, 4, 0): (365, 'High Card', 'J62'),
    (9, 4, 1): (364, 'High Card', 'J63'),
    (9, 4, 2): (363, 'High Card', 'J64'),
    (9, 4, 3): (362, 'High Card', 'J65'),
    (9, 4, 4): (113, 'Pair', '66J'), # ИСПРАВЛЕНО
    (9, 5, 0): (361, 'High Card', 'J72'),
    (9, 5, 1): (360, 'High Card', 'J73'),
    (9, 5, 2): (359, 'High Card', 'J74'),
    (9, 5, 3): (358, 'High Card', 'J75'),
    (9, 5, 4): (357, 'High Card', 'J76'),
    (9, 5, 5): (101, 'Pair', '77J'), # ИСПРАВЛЕНО
    ...
    (9, 8, 8): (65, 'Pair', 'TTJ'), # ИСПРАВЛЕНО
    (9, 9, 0): (61, 'Pair', 'JJ2'), # ИСПРАВЛЕНО
    (9, 9, 1): (60, 'Pair', 'JJ3'), # ИСПРАВЛЕНО
    (9, 9, 2): (59, 'Pair', 'JJ4'), # ИСПРАВЛЕНО
    (9, 9, 3): (58, 'Pair', 'JJ5'), # ИСПРАВЛЕНО
    (9, 9, 4): (57, 'Pair', 'JJ6'), # ИСПРАВЛЕНО
    (9, 9, 5): (56, 'Pair', 'JJ7'), # ИСПРАВЛЕНО
    (9, 9, 6): (55, 'Pair', 'JJ8'), # ИСПРАВЛЕНО
    (9, 9, 7): (54, 'Pair', 'JJ9'), # ИСПРАВЛЕНО
    (9, 9, 8): (53, 'Pair', 'JJT'), # ИСПРАВЛЕНО
    (9, 9, 9): (4, 'Trips', 'JJJ'),
    (10, 0, 0): (160, 'Pair', '22Q'), # ИСПРАВЛЕНО
    (10, 1, 0): (335, 'High Card', 'Q32'),
    (10, 1, 1): (148, 'Pair', '33Q'), # ИСПРАВЛЕНО
    (10, 2, 0): (334, 'High Card', 'Q42'),
    (10, 2, 1): (333, 'High Card', 'Q43'),
    (10, 2, 2): (136, 'Pair', '44Q'), # ИСПРАВЛЕНО
    (10, 3, 0): (332, 'High Card', 'Q52'),
    (10, 3, 1): (331, 'High Card', 'Q53'),
    (10, 3, 2): (330, 'High Card', 'Q54'),
    (10, 3, 3): (124, 'Pair', '55Q'), # ИСПРАВЛЕНО
    (10, 4, 0): (329, 'High Card', 'Q62'),
    (10, 4, 1): (328, 'High Card', 'Q63'),
    (10, 4, 2): (327, 'High Card', 'Q64'),
    (10, 4, 3): (326, 'High Card', 'Q65'),
    (10, 4, 4): (112, 'Pair', '66Q'), # ИСПРАВЛЕНО
    (10, 5, 0): (325, 'High Card', 'Q72'),
    (10, 5, 1): (324, 'High Card', 'Q73'),
    (10, 5, 2): (323, 'High Card', 'Q74'),
    (10, 5, 3): (322, 'High Card', 'Q75'),
    (10, 5, 4): (321, 'High Card', 'Q76'),
    (10, 5, 5): (100, 'Pair', '77Q'), # ИСПРАВЛЕНО
    ...
    (10, 9, 9): (52, 'Pair', 'JJQ'), # ИСПРАВЛЕНО
    (10, 10, 0): (49, 'Pair', 'QQ2'), # ИСПРАВЛЕНО
    (10, 10, 1): (48, 'Pair', 'QQ3'), # ИСПРАВЛЕНО
    (10, 10, 2): (47, 'Pair', 'QQ4'), # ИСПРАВЛЕНО
    (10, 10, 3): (46, 'Pair', 'QQ5'), # ИСПРАВЛЕНО
    (10, 10, 4): (45, 'Pair', 'QQ6'), # ИСПРАВЛЕНО
    (10, 10, 5): (44, 'Pair', 'QQ7'), # ИСПРАВЛЕНО
    (10, 10, 6): (43, 'Pair', 'QQ8'), # ИСПРАВЛЕНО
    (10, 10, 7): (42, 'Pair', 'QQ9'), # ИСПРАВЛЕНО
    (10, 10, 8): (41, 'Pair', 'QQT'), # ИСПРАВЛЕНО
    (10, 10, 9): (40, 'Pair', 'QQJ'), # ИСПРАВЛЕНО
    (10, 10, 10): (3, 'Trips', 'QQQ'),
    (11, 0, 0): (159, 'Pair', '22K'), # ИСПРАВЛЕНО
    (11, 1, 0): (290, 'High Card', 'K32'),
    (11, 1, 1): (147, 'Pair', '33K'), # ИСПРАВЛЕНО
    (11, 2, 0): (289, 'High Card', 'K42'),
    (11, 2, 1): (288, 'High Card', 'K43'),
    (11, 2, 2): (135, 'Pair', '44K'), # ИСПРАВЛЕНО
    (11, 3, 0): (287, 'High Card', 'K52'),
    (11, 3, 1): (286, 'High Card', 'K53'),
    (11, 3, 2): (285, 'High Card', 'K54'),
    (11, 3, 3): (123, 'Pair', '55K'), # ИСПРАВЛЕНО
    (11, 4, 0): (284, 'High Card', 'K62'),
    (11, 4, 1): (283, 'High Card', 'K63'),
    (11, 4, 2): (282, 'High Card', 'K64'),
    (11, 4, 3): (281, 'High Card', 'K65'),
    (11, 4, 4): (111, 'Pair', '66K'), # ИСПРАВЛЕНО
    (11, 5, 0): (280, 'High Card', 'K72'),
    (11, 5, 1): (279, 'High Card', 'K73'),
    (11, 5, 2): (278, 'High Card', 'K74'),
    (11, 5, 3): (277, 'High Card', 'K75'),
    (11, 5, 4): (276, 'High Card', 'K76'),
    (11, 5, 5): (99, 'Pair', '77K'), # ИСПРАВЛЕНО
    ...
    (11, 10, 10): (39, 'Pair', 'QQK'), # ИСПРАВЛЕНО
    (11, 11, 0): (37, 'Pair', 'KK2'), # ИСПРАВЛЕНО
    (11, 11, 1): (36, 'Pair', 'KK3'), # ИСПРАВЛЕНО
    (11, 11, 2): (35, 'Pair', 'KK4'), # ИСПРАВЛЕНО
    (11, 11, 3): (34, 'Pair', 'KK5'), # ИСПРАВЛЕНО
    (11, 11, 4): (33, 'Pair', 'KK6'), # ИСПРАВЛЕНО
    (11, 11, 5): (32, 'Pair', 'KK7'), # ИСПРАВЛЕНО
    (11, 11, 6): (31, 'Pair', 'KK8'), # ИСПРАВЛЕНО
    (11, 11, 7): (30, 'Pair', 'KK9'), # ИСПРАВЛЕНО
    (11, 11, 8): (29, 'Pair', 'KKT'), # ИСПРАВЛЕНО
    (11, 11, 9): (28, 'Pair', 'KKJ'), # ИСПРАВЛЕНО
    (11, 11, 10): (27, 'Pair', 'KKQ'), # ИСПРАВЛЕНО
    (11, 11, 11): (2, 'Trips', 'KKK'),
    (12, 0, 0): (158, 'Pair', '22A'), # ИСПРАВЛЕНО
    (12, 1, 0): (235, 'High Card', 'A32'),
    (12, 1, 1): (146, 'Pair', '33A'), # ИСПРАВЛЕНО
    (12, 2, 0): (234, 'High Card', 'A42'),
    (12, 2, 1): (233, 'High Card', 'A43'),
    (12, 2, 2): (134, 'Pair', '44A'), # ИСПРАВЛЕНО
    (12, 3, 0): (232, 'High Card', 'A52'),
    (12, 3, 1): (231, 'High Card', 'A53'),
    (12, 3, 2): (230, 'High Card', 'A54'),
    (12, 3, 3): (122, 'Pair', '55A'), # ИСПРАВЛЕНО
    (12, 4, 0): (229, 'High Card', 'A62'),
    (12, 4, 1): (228, 'High Card', 'A63'),
    (12, 4, 2): (227, 'High Card', 'A64'),
    (12, 4, 3): (226, 'High Card', 'A65'),
    (12, 4, 4): (110, 'Pair', '66A'), # ИСПРАВЛЕНО
    (12, 5, 0): (225, 'High Card', 'A72'),
    (12, 5, 1): (224, 'High Card', 'A73'),
    (12, 5, 2): (223, 'High Card', 'A74'),
    (12, 5, 3): (222, 'High Card', 'A75'),
    (12, 5, 4): (221, 'High Card', 'A76'),
    (12, 5, 5): (98, 'Pair', '77A'), # ИСПРАВЛЕНО
    ...
    (12, 10, 10): (38, 'Pair', 'QQA'), # ИСПРАВЛЕНО
    ...
    (12, 11, 11): (26, 'Pair', 'KKA'), # ИСПРАВЛЕНО
    (12, 12, 0): (25, 'Pair', 'AA2'), # ИСПРАВЛЕНО
    (12, 12, 1): (24, 'Pair', 'AA3'), # ИСПРАВЛЕНО
    (12, 12, 2): (23, 'Pair', 'AA4'), # ИСПРАВЛЕНО
    (12, 12, 3): (22, 'Pair', 'AA5'), # ИСПРАВЛЕНО
    (12, 12, 4): (21, 'Pair', 'AA6'), # ИСПРАВЛЕНО
    (12, 12, 5): (20, 'Pair', 'AA7'), # ИСПРАВЛЕНО
    (12, 12, 6): (19, 'Pair', 'AA8'), # ИСПРАВЛЕНО
    (12, 12, 7): (18, 'Pair', 'AA9'), # ИСПРАВЛЕНО
    (12, 12, 8): (17, 'Pair', 'AAT'), # ИСПРАВЛЕНО
    (12, 12, 9): (16, 'Pair', 'AAJ'), # ИСПРАВЛЕНО
    (12, 12, 10): (15, 'Pair', 'AAQ'), # ИСПРАВЛЕНО
    (12, 12, 11): (14, 'Pair', 'AAK'), # ИСПРАВЛЕНО
